        ...
        <div className="w-screen">
            <div className="flex flex-row w-4/6 mx-auto px-10 py-5 2xl:w-4/6 xl:w-4/6 l:w-4/6 md:w-5/6 sm:w-screen items-center">
                ...
                <div className="mr-auto flex flex-row">
                    <h2 className="text-2xl mr-10">Tutors</h2>
                    <h2 className="text-2xl mr-10">Subjects</h2>
                    <h2 className="text-2xl mr-10">About</h2>
                    <h2 className="text-2xl mr-10">Contact</h2>
